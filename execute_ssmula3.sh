...
# two equal rounds
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=240 --batch_size=240 --budget=240 --runs=50 --output_path=results/2eq_240+240/

python execute_simulation.py --device=cuda:1 --n_pseudorand_init=60 --batch_size=60 --budget=60 --runs=50 --output_path=results/2eq_60/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=72 --batch_size=72 --budget=72 --runs=50 --output_path=results/2eq_72/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=96 --batch_size=96 --budget=96 --runs=50 --output_path=results/2eq_96/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=144 --batch_size=144 --budget=144 --runs=50 --output_path=results/2eq_144/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=192 --batch_size=192 --budget=192 --runs=50 --output_path=results/2eq_192/
python execute_simulation.py --device=cuda:1--n_pseudorand_init=288 --batch_size=288 --budget=288 --runs=50 --output_path=results/2eq_288/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=336 --batch_size=336 --budget=336 --runs=50 --output_path=results/2eq_336/
python execute_simulation.py --device=cuda:1 --n_pseudorand_init=528 --batch_size=528 --budget=528 --runs=50 --output_path=results/2eq_528/
python execute_simulation.py  --device=cuda:1 --n_pseudorand_init=1008 --batch_size=1008 --budget=1008 --runs=50 --output_path=results/2eq_1008/
