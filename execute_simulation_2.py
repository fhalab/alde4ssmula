...
if __name__ == "__main__":
    ...
    parser.add_argument("--names", type=list, default=["TEV", "TrpB3A", "TrpB3B", "TrpB3C", "TrpB3D", "TrpB3E", "TrpB3F", "TrpB3G", "TrpB3H", "TrpB3I", "TrpB4"])
    ...
    parser.add_argument(
        "--zs_folder",
        type=str,
        default="/disk2/fli/SSMuLA/results/zs_comb_5/none/scale2max/all",
    )
    parser.add_argument(
